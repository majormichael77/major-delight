...
<!-------this is using session in php to check who is logged in and what to dispaly on the nav------->
                      <?php 
                    ...
                    ?>
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="admin_page.php"><i class="fas fa-user-lock"></i>  <b>Admin </b></a>
                        </li>
            
                        
            
                        <li class="nav-item">
                          <a class="nav-link"  href="admin_logout.php"><i class="fas fa-sign-out-alt"></i></a>
                        </li>
                      </ul>
